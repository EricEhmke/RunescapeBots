...
class runescape_instance():
    ...
    def __init__(self, position):
        ...
        self.loc_inventory_item = (self.bottom_right_corner[0]+930, self.bottom_right_corner[1]+345),\
                                  (self.bottom_right_corner[0]+949, self.bottom_right_corner[1]+365)
...
def find_up_to_date_buy_price(runescape_window, ge_slot):
    ...
    runescape_window.enter_price(1)
    pyautogui.press('enter')
